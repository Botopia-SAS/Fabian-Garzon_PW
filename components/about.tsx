const About = () => {
  return (
    <section className="py-16 px-6 sm:px-8 md:px-12 lg:px-24 dark:bg-white dark:text-black">
      <div className="max-w-3xl mx-auto text-center">
        {/* Columna de texto */}
        <div>
          <h2 className="font-bold text-black mt-10 mb-6 text-4xl">About</h2>
          <p className="text-black mb-4 leading-relaxed text-justify">
            ...
            <br></br>
            <br></br>
            Born in Bogotá, Colombia, Fabian discovered photography at 12 when
            his father gifted him a Zenith camera, sparking a lifelong passion.
            At 18, he moved to Miami, collaborating with talent and modeling
            agencies, before heading to Toronto, Canada’s fashion hub, where he
            earned a degree in digital photography.
            <br></br>
            <br></br>
